 ...
 * @property {string=} stage - The stage to use for the deployment
 * @property {string} domain - The domain name to use for the deployment (e.g. files.uploadshare.click)
 * @property {string=} serviceName - The name of the service (for resource naming), default: 'uploadshare'
 */

/**
 * @type {Region}
 */
const defaultRegion = /** @type {Region} */ (process.env.AWS_REGION) || /** @type {Region} */ (process.env.DEFAULT_AWS_REGION) || 'ap-northeast-2'

const defaultConfig = {
  region: defaultRegion,
  stage: 'dev',
  serviceName: 'uploadshare'
}
